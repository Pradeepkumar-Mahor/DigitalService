# Contributing to DigitalService.UI
...
1. Contribution Requirements :
    * When you contribute, you agree to give a non-exclusive license to DigitalService.UI.io to use that contribution in any context as we (DigitalService.UI.io) see appropriate.
...
- clone the `DigitalService.UI` repo.
