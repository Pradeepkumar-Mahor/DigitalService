...
All notable changes to DigitalService.UI will be documented in this file.
...
This release represents a complete modernization of the DigitalService.UI codebase, bringing it up to current standards with the latest tooling, dependencies, and best practices.
