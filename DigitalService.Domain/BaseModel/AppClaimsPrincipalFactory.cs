...
namespace DigitalService.Domain.BaseModel
{
    ...
    public static class CustomClaimTypes
    {
        ...
        //
        // Summary:
        //     The URI for a claim that specifies the Windows DigitalService.Domain account name of an entity,
        ...
        #endregion Default ClaimTypes (taken from ClaimTypes class)
